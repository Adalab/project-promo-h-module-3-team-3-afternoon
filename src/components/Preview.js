        ...
        <section className="page__cardpreview">
            <div className="card__preview">
                <div className={`card__box theme-colors1 ${selectTheme()}`}>
                    <button className="card__reset" onClick={props.resetForm}><i className="far fa-trash-alt"></i>Reset</button>
                    ...
                    <div className="card__photo" style={{backgroundImage: `url(${props.avatar})`}}></div>
